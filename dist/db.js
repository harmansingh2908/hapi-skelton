    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          mongoUrl = db.auth ? 'mongodb://' + db.username + ':' + db.password + '@' + db.host + ':' + db.port + '/' + db.name : 'mongodb://' + db.host + ':' + db.port + '/' + db.name;
          ...
          _mongoose2.default.connect(mongoUrl, _config2.default.get('db.mongoose'), function (err) {
            if (err) {
              ...
              _logger2.default.info('+++ MongoDB Connected', mongoUrl);
            }
          });
